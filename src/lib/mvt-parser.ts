...
// Mantiene los informes subidos compactos. La evidencia completa permanece en
// el ZIP/carpeta local; en la base de datos guardamos sólo campos útiles para
// la UI, traducciones y heurísticas.
