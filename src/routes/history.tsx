  ...
  return (
    <AppShell>
      <div className="p-6 md:p-10 max-w-7xl mx-auto">
        ...
        <p className="text-sm text-muted-foreground mt-1">Todos tus análisis previos. Puedes eliminarlos definitivamente.</p>

        {items.length === 0 ? (
          <div className="mt-10 rounded-xl border border-dashed border-border p-12 text-center text-sm text-muted-foreground">Sin análisis todavía.</div>
        ) : (
